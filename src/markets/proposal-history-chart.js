import { createProposalHistoryChart as createLivelineProposalHistoryChart } from './proposal-history-liveline.js';
import {
...
// Renderer-neutral decision-history helpers retained for existing consumers.
...
/**
 * Compatibility entry point for the current Liveline proposal renderer.
 */
export function createProposalHistoryChart(options = {}) {
  return createLivelineProposalHistoryChart(options);
}
